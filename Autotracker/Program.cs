...
namespace Autotracker
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // DI
            ISamplerConfigurationFactory samplerConfigurationFactory = new ImpulseTrackerSamplerConfigurationFactory();
            ...
            (
                random.Next(50, 50 + 12 - 1) + 12,
                (random.NextDouble() < 0.6) ? KeyMasks.Minor : KeyMasks.Major,
                128,
                32
            );
